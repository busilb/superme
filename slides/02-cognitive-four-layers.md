...
![bg opacity:0.25](../assets/course-cover-02.png)

# 认知四层跃迁模型

## 企业AI转型的底层操作系统 | 高管内训课程
...
| 72% | ¥1万/天 | 3个月 | 10x |
|-----|---------|-------|-----|
| AI培训未产生可衡量回报 | 人均AI算力预算 | 认知到融合周期 | 行为改变后效率提升 |
...
![bg opacity:0.15](../assets/slide-attachment.png)
...
![bg opacity:0.15](../assets/slide-ignorance.png)
...
![bg opacity:0.15](../assets/slide-impermanence.png)
...
![bg opacity:0.15](../assets/slide-interdependence.png)
